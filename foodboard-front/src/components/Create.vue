<template>
    <div v-if="visible" class="modal-overlay" @click.self="close">
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          ...
          <!-- Pour simplifier, ingrédients en texte libre -->
          <label>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        // Ici tu peux faire un emit pour envoyer les données au parent,
        // ou appeler directement une API via axios (à adapter)
        const newRecipe = {
          title: this.title,
